...
export function normalizeRow(
    ...
    return {
        ...
        market: parseStr(get('market')).toUpperCase() || undefined,
        objective: parseStr(get('objective')).toUpperCase() || undefined,
        sector: parseStr(get('sector')).toUpperCase() || undefined,
        period: parseStr(get('period')) || undefined,
        year: get('year') ? Number(get('year')) : undefined,
        month: get('month') ? Number(get('month')) : undefined,
        currency: parseStr(get('currency')).toUpperCase() || 'EUR',
        spend,
        impressions,
